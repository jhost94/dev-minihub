...
import center.jhub.dev.service.SSEService;
import center.jhub.dev.service.SSEService.SSEOptions;
...
public class SSEApiController {
    ...
    public SseEmitter genericObjectRest(@RequestBody DevRestInDTO dto,
                                        @RequestParam(required = false) Long duration, @RequestParam(required = false) TimeUnit durationUnit,
                                        @RequestParam(required = false) Long delay, @RequestParam(required = false) TimeUnit delayUnit,
                                        @RequestParam(required = false) Long frequency, @RequestParam(required = false) TimeUnit frequencyUnit,
                                        @RequestParam(required = false) String eventName,
                                        @RequestParam(required = false) Boolean sendComment,
                                        @RequestParam(required = false) List<String> commentValues,
                                        @RequestParam(required = false) Long commentFrequency, @RequestParam(required = false) TimeUnit commentFrequencyUnit) {
        SSEOptions options = SSEOptions.create(
            ...
            sendComment,
            commentValues,
            commentFrequency, commentFrequencyUnit
        );
        return sseService.createStream(dto, options);
    }
    ...
    public SseEmitter getObjectRest(@RequestParam String template,
                                    @RequestParam(required = false) Long duration, @RequestParam(required = false) TimeUnit durationUnit,
                                    @RequestParam(required = false) Long delay, @RequestParam(required = false) TimeUnit delayUnit,
                                    @RequestParam(required = false) Long frequency, @RequestParam(required = false) TimeUnit frequencyUnit,
                                    @RequestParam(required = false) String eventName,
